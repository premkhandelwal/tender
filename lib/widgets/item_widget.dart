    ...
    return isVender
        ? StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                // .where('vendorId', isNotEqualTo: userGoogleId)
                .snapshots(),
              ...
              return snapshot.connectionState == ConnectionState.waiting
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        print(vendordata['vendorId'] != userGoogleId &&
                            !isVender);

                        if ((vendordata['vendorId'] != userGoogleId &&
                            vendordata['image'] == data['imgUrl'] &&
                            vendordata['productName'] == data['name'])) {
                          return Card(
